...
export const MOCK_PROJECTS = [
    ...
    new Project({
        id: 2,
        name: "Wisozk Group",
        description: "Centralized interactive application.",
    ...
    new Project({
        id: 3,
        name: "Denesik LLC",
        description: "Re-contextualized dynamic moratorium.",
    ...
    new Project({
        ...
        description: "Innovative 6th generation model.",
    ...
    new Project({
        ...
        description: "Managed logistical migration.",
        imageUrl: "/assets/placeimg_500_300_arch12.jpg",
        contractTypeId: 2,
    ...
    new Project({
        id: 6,
        name: "Lesch - Waelchi",
        description: "Profound mobile project.",
        imageUrl: "/assets/placeimg_500_300_arch1.jpg",
        contractTypeId: 3,
        contractSigned: "2016-09-23T21:27:25.035Z",
        budget: 53407,
        isActive: false,
    }),
];
